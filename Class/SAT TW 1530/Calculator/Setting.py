...
MATH_POSITIONS = {
    '/' : {'col':3, 'row':2, 'character':'', 'operator':'/', 'image path':{'light':'Calculator/light_div.png', 'dark':'Calculator/dark_div.png'}},
...
OPERATORS = {
    ...
    'invert' : {'col':1, 'row':2, 'text':'', 'image path':{'light':'Calculator/light_invert.png', 'dark':'Calculator/dark_invert.png'}},
