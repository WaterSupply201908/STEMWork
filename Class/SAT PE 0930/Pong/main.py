...
while True :
  ...
  if ball_pos[0] <= bat1_pos[0]+BAT_WIDTH and bat1_pos[1] < ball_pos[1] < bat1_pos[1]+BAT_HEIGHT :
    ball_velocity[0] = -ball_velocity[0]
  if ball_pos[0] >= bat2_pos[0]-BAT_WIDTH and bat2_pos[1] < ball_pos[1] < bat2_pos[1]+BAT_HEIGHT :
    ball_velocity[0] = -ball_velocity[0]

  ## Check ball collision with left & right walls
  if ball_pos[0] < 0 or ball_pos[0] > WIDTH :
    ball_pos = [WIDTH//2-BALL_SIZE//2, HEIGHT//2-BALL_SIZE//2]
    ball_velocity = [BALL_SPEED * (-1 if ball_velocity[0] > 0 else 1), ball_velocity[1]]
