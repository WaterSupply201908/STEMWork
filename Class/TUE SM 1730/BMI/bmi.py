...
class App(ctk.CTk) :
    ...
    def update_bmi(self, *args) :
        # BMI = kg / (m*m)
        height_meter = self.height_int.get() / 100 # m
...
class ResultText(ctk.CTkLabel) :
    def __init__(self, parent, bmi_string) :
        font = ctk.CTkFont(family='Courier New', size=100, weight='bold')
...
class WeightInput(ctk.CTkFrame) :
    def __init__(self, parent, weight_float, metric_bool) :
        ...
        label = ctk.CTkLabel(self, textvariable=self.output_string, text='70kg',
