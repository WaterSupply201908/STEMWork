# Lesson 2: CSS Styling & STEM WORK Design
# Duration: 1 hour
# Objective: Add professional CSS styling to homepage

"""
LEARNING OBJECTIVES:
- Learn CSS basics (selectors, properties, values)
- Apply STEM WORK color scheme
- Create professional layout
- Add hero section and styled content boxes
"""
...
"""
WHAT STUDENTS LEARN IN LESSON 2:

Building on Lesson 1:
- Same homepage content from Lesson 1
- Add professional CSS styling to make it beautiful

CSS Basics:
- Inline CSS with <style> tag
- Selectors (*, body, .class)
- Colors (hex codes like #2c5aa0)
- Spacing (margin, padding)
- Border-radius for rounded corners

Layout:
- Max-width containers (1200px) for responsive design
- White content boxes with shadows
- Centered layouts

Styling Components:
- Navigation bar with logo
- Hero section with gradient background (STEM WORK blue #2c5aa0)
- Content boxes with rounded corners and shadows
- Footer with STEM WORK blue background
- Styled lists with proper spacing

LESSON 3: We'll add SQLite database to store 15 projects and create a database 
setup script. Students will learn SQL basics (CREATE TABLE, INSERT, SELECT).
"""
