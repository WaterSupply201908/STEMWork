...
class Player(Entity):
    def __init__(self,pos,groups,obstacle_sprites,create_attack,destroy_attack,create_magic):
        ...
        self.max_stats = {'health': 300, 'energy': 180, 'attack': 20, 'magic': 20, 'speed':20}
    ...
    def get_full_weapon_damage(self):
        ...
        weapon_damge = weapon_data[self.weapon]['damage']
        return base_damage + weapon_damge
